...
class AgeFinderTest {
    ...
    void testCalculateAge_withEdgeCases() {
        ...
        int expected = Period.between(birthDate, currentDate).getYears();
        assertThat(ageFinder.calculateAge(date))
        ...
        birthDate = LocalDate.parse(minDate, formatter);
        int minExpected = Period.between(birthDate, currentDate).getYears();
