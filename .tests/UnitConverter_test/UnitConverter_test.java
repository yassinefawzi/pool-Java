...
class UnitConverterTest {
    ...
    void testPoundsToKilograms() {
       assertThat(UnitConverter.convert(new String[]{"pounds", "kilograms", "33"})).isEqualTo("14.97");
    }

     @Test
    void testUnsupportedConversion() {
        assertThat(UnitConverter.convert(new String[]{"pounds", "kilometers", "10"})).isEqualTo("ERROR");
        assertThat(UnitConverter.convert(new String[]{"pounds", "miles", "10"})).isEqualTo("ERROR");
        assertThat(UnitConverter.convert(new String[]{"miles", "kilograms", "10"})).isEqualTo("ERROR");
        assertThat(UnitConverter.convert(new String[]{"celsius", "kilograms", "10"})).isEqualTo("ERROR");
    }
